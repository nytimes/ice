...
"";this._ice.element.appendChild(a);var g=this._ice.getCurrentRange();g.setStartAfter(this._tmpNode);g.collapse(!0);var h=null,e=g.createContextualFragment(e),f=this._ice.startBatchChange(this._ice.changeTypes.insertType.alias);if(c.dom.hasBlockChildren(e)){var k=c.dom.isChildOfTagName(this._tmpNode,this._ice.blockEl);g.setEndAfter(k.lastChild);this._ice.selection.addRange(g);var h=g.extractContents(),n=c.env.document.createElement(this._ice.blockEl);n.appendChild(h);c.dom.insertAfter(k,n);g.setStart(n,
0);g.collapse(!0);this._ice.selection.addRange(g);for(var g=g.startContainer,l=null,k=null;e.firstChild;)if(e.firstChild.nodeType===3&&!jQuery.trim(e.firstChild.nodeValue))e.removeChild(e.firstChild);else if(c.dom.isBlockElement(e.firstChild)){if(e.firstChild.textContent!=="")k=l=null,this._ice.isTracking?(k=this._ice.createIceNode("insertType"),this._ice.addChange("insertType",[k]),h=document.createElement(e.firstChild.tagName),k.innerHTML=e.firstChild.innerHTML,h.appendChild(k)):(k=h=document.createElement(e.firstChild.tagName),
h.innerHTML=e.firstChild.innerHTML),c.dom.insertBefore(g,h);e.removeChild(e.firstChild)}else l||(h=document.createElement(this._ice.blockEl),c.dom.insertBefore(g,h),this._ice.isTracking?(l=this._ice.createIceNode("insertType"),this._ice.addChange("insertType",[l]),h.appendChild(l)):l=h),k=l,l.appendChild(e.removeChild(e.firstChild));n.textContent||n.parentNode.removeChild(n)}else if(this._ice.isTracking)h=this._ice.createIceNode("insertType",e),this._ice.addChange("insertType",[h]),g.insertNode(h),
k=h;else for(;n=e.firstChild;)g.insertNode(n),g.setStartAfter(n),g.collapse(!0),k=n;this._ice.endBatchChange(f);this._cleanup(k)},createDiv:function(a){var b=c.dom.getId(a);if(b)return c.dom.empty(b),b;b=c.env.document.createElement("div");b.id=a;b.setAttribute("contentEditable",!0);c.dom.setStyle(b,"width","0px");c.dom.setStyle(b,"height","0px");c.dom.setStyle(b,"overflow","hidden");c.dom.setStyle(b,"position","fixed");c.dom.setStyle(b,"top","10px");c.dom.setStyle(b,"left","10px");document.body.appendChild(b);
...
if(f!==null)return!1});return f},_convertWordPasteList:function(a){var b=document.createElement("div"),e=null,f=null,g={},h=null,k=!0,n={ul:{circle:["^o(s|&nbsp;)+"],disc:["^"+String.fromCharCode(183)+"(\\s|&nbsp;)+"],square:["^"+String.fromCharCode(167)+"(\\s|&nbsp;)+"],auto:["^"+String.fromCharCode(8226)+"(\\s|&nbsp;)+"]},ol:{decimal:["^\\d+\\.(s|&nbsp;)+"],"lower-roman":["^[ivxlcdm]+\\.(\\s|&nbsp;)+"],"upper-roman":["^[IVXLCDM]+\\.(\\s|&nbsp;)+"],"lower-alpha":["^[a-z]+\\.(\\s|&nbsp;)+"],"upper-alpha":["^[A-Z]+\\.(\\s|&nbsp;)+"]}};
c.dom.setHtml(b,a);for(var a=c.dom.getTag("p",b),l=a.length,s=0;s<l;s++){var o=a[s],i=this._getListType(o,n);if(i!==null){var q=parseInt(c.dom.getStyle(o,"margin-left")),j=i.listType,p=i.listStyle;c.dom.setHtml(o,i.html);j||(j="ol");k?(e=document.createElement(j),g={},c.dom.attr(e,"_icelistst","list-style-type:"+p),g[q]=e,c.dom.insertBefore(o,e)):q!==f&&(c.dom.isset(g[q])===!0?e=g[q]:q>f&&(e=document.createElement(j),c.dom.attr(e,"_icelistst","list-style-type:"+p),h.appendChild(e),g[q]=e));h=this._createListItemFromElement(o);
e.appendChild(h);f=q;c.dom.remove(o);k=!1}else k=!0}return a=c.dom.getHtml(b)},_createListItemFromElement:function(a){for(var b=document.createElement("li");a.firstChild;)b.appendChild(a.firstChild);return b},_cleanPaste:function(a){a=a.replace(/<b(\s+|>)/g,"<strong$1");a=a.replace(/<\/b(\s+|>)/g,"</strong$1");a=a.replace(/<i(\s+|>)/g,"<em$1");return a=a.replace(/<\/i(\s+|>)/g,"</em$1")},_cleanup:function(a){try{var a=a&&a.lastChild||a||this._tmpNode,b=this._ice.getCurrentRange();b.setStart(a,a.length);
