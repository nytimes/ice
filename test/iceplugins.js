...
/*
	...
	test("IceCopyPastePlugin.handleFormattedPasteValue", function() {
		...
		ok(el.text().trim() === 'Some contentA paragraph.', 'Text content was pasted in correctly.');
		...
		ok(el.find('div, strong, b, ol, li, em').length === 2
