...
**/
window.rangy=function(){function c(a,b){var d=typeof a[b];return d==n||!!(d==k&&a[b])||d=="unknown"}function b(a,b){return!!(typeof a[b]==k&&a[b])}function a(a,b){return typeof a[b]!=l}function d(a){return function(b,d){for(var c=d.length;c--;)if(!a(b,d[c]))return!1;return!0}}function e(a){return a&&j(a,q)&&x(a,i)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);r.initialized=!0;r.supported=!1}function g(){if(!r.initialized){var a,d=!1,p=!1;c(document,"createRange")&&
(a=document.createRange(),j(a,o)&&x(a,s)&&(d=!0),a.detach());if((a=b(document,"body")?document.body:document.getElementsByTagName("body")[0])&&c(a,"createTextRange"))a=a.createTextRange(),e(a)&&(p=!0);!d&&!p&&f("Neither Range nor TextRange are implemented");r.initialized=!0;r.features={implementsDomRange:d,implementsTextRange:p};d=E.concat(w);p=0;for(a=d.length;p<a;++p)try{d[p](r)}catch(g){b(window,"console")&&c(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
g)}}}function h(a){this.name=a;this.supported=this.initialized=!1}var k="object",n="function",l="undefined",s=["startContainer","startOffset","endContainer","endOffset","collapsed","commonAncestorContainer","START_TO_START","START_TO_END","END_TO_START","END_TO_END"],o=["setStart","setStartBefore","setStartAfter","setEnd","setEndBefore","setEndAfter","collapse","selectNode","selectNodeContents","compareBoundaryPoints","deleteContents","extractContents","cloneContents","insertNode","surroundContents",
"cloneRange","toString","detach"],i=["boundingHeight","boundingLeft","boundingTop","boundingWidth","htmlText","text"],q=["collapse","compareEndPoints","duplicate","getBookmark","moveToBookmark","moveToElementText","parentElement","pasteHTML","select","setEndPoint","getBoundingClientRect"],j=d(c),p=d(b),x=d(a),r={version:"1.2",initialized:!1,supported:!0,util:{isHostMethod:c,isHostObject:b,isHostProperty:a,areHostMethods:j,areHostObjects:p,areHostProperties:x,isTextRange:e},features:{},modules:{},
...
a.parentNode;)a=b;return a},comparePoints:function(b,c,f,j){var g;if(b==f)return c===j?0:c<j?-1:1;else if(g=e(f,b,!0))return c<=a(g)?-1:1;else if(g=e(b,f,!0))return a(g)<j?-1:1;else if(c=d(b,f),b=b===c?c:e(b,c,!0),f=f===c?c:e(f,c,!0),b===f)throw Error("comparePoints got to case 4 and childA and childB are the same!");else{for(c=c.firstChild;c;){if(c===b)return-1;else if(c===f)return 1;c=c.nextSibling}throw Error("Should not be here!");}},inspectNode:k,createIterator:function(a){return new n(a)},DomPosition:l};
c.DOMException=s});
...
var d=this.startContainer,c=this.startOffset,e=this.commonAncestorContainer,t=new i(this,!0);if(d!==e)d=m.getClosestAncestorIn(d,e,!0),c=f(d),d=c.node,c=c.offset;k(t,z);t.reset();e=a(t);t.detach();b(this,d,c,d,c);return e}}function D(a,d,j){function g(a,b){return function(d){r(this);w(d,N);w(t(d),I);d=(a?e:f)(d);(b?D:k)(this,d.node,d.offset)}}function D(a,b,c){var e=a.endContainer,f=a.endOffset;if(b!==a.startContainer||c!==this.startOffset){if(t(b)!=t(e)||m.comparePoints(b,c,e,f)==1)e=b,f=c;d(a,b,
c,e,f)}}function k(a,b,c){var e=a.startContainer,f=a.startOffset;if(b!==a.endContainer||c!==this.endOffset){if(t(b)!=t(e)||m.comparePoints(b,c,e,f)==-1)e=b,f=c;d(a,e,f,b,c)}}function L(a,b,c){(b!==a.startContainer||c!==this.startOffset||b!==a.endContainer||c!==this.endOffset)&&d(a,b,c,b,c)}a.prototype=new G;c.util.extend(a.prototype,{setStart:function(a,b){r(this);x(a,!0);E(a,b);D(this,a,b)},setEnd:function(a,b){r(this);x(a,!0);E(a,b);k(this,a,b)},setStartBefore:g(!0,!0),setStartAfter:g(!1,!0),setEndBefore:g(!0,
!1),setEndAfter:g(!1,!1),collapse:function(a){v(this);a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){r(this);x(a,!0);d(this,a,0,a,m.getNodeLength(a))},selectNode:function(a){r(this);x(a,!1);w(a,N);var b=e(a),a=f(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:F(l,d),deleteContents:F(n,d),canSurroundContents:function(){v(this);z(this.startContainer);
z(this.endContainer);var a=new i(this,!0),d=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!d},detach:function(){j(this)},splitBoundaries:function(){v(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,e=this.endOffset,t=a===c;m.isCharacterDataNode(c)&&e>0&&e<c.length&&m.splitDataNode(c,e);m.isCharacterDataNode(a)&&b>0&&b<a.length&&(a=m.splitDataNode(a,b),t?(e-=b,c=a):c==a.parentNode&&e>=m.getNodeIndex(a)&&e++,b=0);d(this,a,b,c,e)},normalizeBoundaries:function(){v(this);
var a=this.startContainer,b=this.startOffset,c=this.endContainer,e=this.endOffset,t=function(a){var b=a.nextSibling;if(b&&b.nodeType==a.nodeType)c=a,e=a.length,a.appendData(b.data),b.parentNode.removeChild(b)},f=function(d){var t=d.previousSibling;if(t&&t.nodeType==d.nodeType){a=d;var f=d.length;b=t.length;d.insertData(0,t.data);t.parentNode.removeChild(t);a==c?(e+=b,c=a):c==d.parentNode&&(t=m.getNodeIndex(d),e==t?(c=d,e=f):e>t&&e--)}},j=!0;m.isCharacterDataNode(c)?c.length==e&&t(c):(e>0&&(j=c.childNodes[e-
1])&&m.isCharacterDataNode(j)&&t(j),j=!this.collapsed);j?m.isCharacterDataNode(a)?b==0&&f(a):b<a.childNodes.length&&(t=a.childNodes[b])&&m.isCharacterDataNode(t)&&f(t):(a=c,b=e);d(this,a,b,c,e)},collapseToPoint:function(a,b){r(this);x(a,!0);E(a,b);L(this,a,b)}});H(a)}function O(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:m.getCommonAncestor(a.startContainer,a.endContainer)}function M(a,b,c,e,t){var f=a.startContainer!==
b||a.startOffset!==c,j=a.endContainer!==e||a.endOffset!==t;a.startContainer=b;a.startOffset=c;a.endContainer=e;a.endOffset=t;O(a);d(a,"boundarychange",{startMoved:f,endMoved:j})}function C(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};O(this)}c.requireModules(["DomUtil"]);var m=c.dom,u=m.DomPosition,B=c.DOMException;i.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=
...
var d=b.getNodes([3]);return d.length>0?(b.setStart(d[0],0),a=d.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){v(this);return new j(this,a,b)},getNodes:function(a,b){v(this);return s(this,a,b)},getDocument:function(){return a(this)},collapseBefore:function(a){r(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){r(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},
...
rangy.createModule("WrappedRange",function(c){function b(a,b,d,c){var g=a.duplicate();g.collapse(d);var i=g.parentElement();e.isAncestorOf(b,i,!0)||(i=b);if(!i.canHaveHTML)return new f(i.parentNode,e.getNodeIndex(i));var b=e.getDocument(i).createElement("span"),q,j=d?"StartToStart":"StartToEnd";do i.insertBefore(b,b.previousSibling),g.moveToElementText(b);while((q=g.compareEndPoints(j,a))>0&&b.previousSibling);j=b.nextSibling;if(q==-1&&j&&e.isCharacterDataNode(j)){g.setEndPoint(d?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(j.data)){i=g.duplicate();d=i.text.replace(/\r\n/g,"\r").length;for(d=i.moveStart("character",d);i.compareEndPoints("StartToEnd",i)==-1;)d++,i.moveStart("character",1)}else d=g.text.length;i=new f(j,d)}else j=(c||!d)&&b.previousSibling,i=(d=(c||d)&&b.nextSibling)&&e.isCharacterDataNode(d)?new f(d,0):j&&e.isCharacterDataNode(j)?new f(j,j.length):new f(i,e.getNodeIndex(b));b.parentNode.removeChild(b);return i}function a(a,b){var d,c,f=a.offset,g=e.getDocument(a.node),q=g.body.createTextRange(),
j=e.isCharacterDataNode(a.node);j?(d=a.node,c=d.parentNode):(d=a.node.childNodes,d=f<d.length?d[f]:null,c=a.node);g=g.createElement("span");g.innerHTML="&#feff;";d?c.insertBefore(g,d):c.appendChild(g);q.moveToElementText(g);q.collapse(!b);c.removeChild(g);if(j)q[b?"moveStart":"moveEnd"]("character",f);return q}c.requireModules(["DomUtil","DomRange"]);var d,e=c.dom,f=e.DomPosition,g=c.DomRange;if(c.features.implementsDomRange&&(!c.features.implementsTextRange||!c.config.preferTextRange))(function(){function a(b){for(var d=
...
!b)b=c.createNativeRange(j.getDocument(a.startContainer)),b.setEnd(a.endContainer,a.endOffset),b.setStart(a.startContainer,a.startOffset),a._selectionNativeRange=b,a.attachListener("detach",function(){this._selectionNativeRange=null})}else a instanceof r?b=a.nativeRange:c.features.implementsDomRange&&a instanceof j.getWindow(a.startContainer).Range&&(b=a);return b}function h(a){var b=a.getNodes(),d;a:if(!b.length||b[0].nodeType!=1)d=!1;else{d=1;for(var c=b.length;d<c;++d)if(!j.isAncestorOf(b[0],b[d])){d=
!1;break a}d=!0}if(!d)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function k(a,b){var d=new r(b);a._ranges=[d];e(a,d,!1);a.rangeCount=1;a.isCollapsed=d.collapsed}function n(a){a._ranges.length=0;if(a.docSelection.type=="None")f(a);else{var b=a.docSelection.createRange();if(b&&typeof b.text!="undefined")k(a,b);else{a.rangeCount=b.length;for(var d,g=j.getDocument(b.item(0)),D=0;D<a.rangeCount;++D)d=c.createRange(g),d.selectNode(b.item(D)),
a._ranges.push(d);a.isCollapsed=a.rangeCount==1&&a._ranges[0].collapsed;e(a,a._ranges[a.rangeCount-1],!1)}}}function l(a,b){for(var d=a.docSelection.createRange(),c=h(b),e=j.getDocument(d.item(0)),e=j.getBody(e).createControlRange(),f=0,g=d.length;f<g;++f)e.add(d.item(f));try{e.add(c)}catch(D){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}e.select();n(a)}function s(a,b,d){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=d;this.refresh()}function o(a,b){for(var d=j.getDocument(b[0].startContainer),d=j.getBody(d).createControlRange(),c=0,e;c<rangeCount;++c){e=h(b[c]);try{d.add(e)}catch(f){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}d.select();n(a)}function i(a,b){if(a.anchorNode&&j.getDocument(a.anchorNode)!==j.getDocument(b))throw new w("WRONG_DOCUMENT_ERR");}function q(a){var b=[],d=new E(a.anchorNode,a.anchorOffset),
c=new E(a.focusNode,a.focusOffset),e=typeof a.getName=="function"?a.getName():"Selection";if(typeof a.rangeCount!="undefined")for(var f=0,g=a.rangeCount;f<g;++f)b[f]=x.inspect(a.getRangeAt(f));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+d.inspect()+", focus: "+c.inspect()+"]"}c.requireModules(["DomUtil","DomRange","WrappedRange"]);c.config.checkSelectionRanges=!0;var j=c.dom,p=c.util,x=c.DomRange,r=c.WrappedRange,w=c.DOMException,E=j.DomPosition,A,z,y=c.util.isHostMethod(window,"getSelection"),
v=c.util.isHostObject(document,"selection"),G=v&&(!y||c.config.preferTextRange);G?(A=d,c.isSelectionValid=function(a){var a=(a||window).document,b=a.selection;return b.type!="None"||j.getDocument(b.createRange().parentElement())==a}):y?(A=a,c.isSelectionValid=function(){return!0}):b.fail("Neither document.selection or window.getSelection() detected.");c.getNativeSelection=A;var y=A(),J=c.createNativeRange(document),H=j.getBody(document),F=p.areHostObjects(y,p.areHostProperties(y,["anchorOffset","focusOffset"]));
c.features.selectionHasAnchorAndFocus=F;var D=p.isHostMethod(y,"extend");c.features.selectionHasExtend=D;var O=typeof y.rangeCount=="number";c.features.selectionHasRangeCount=O;var M=!1,C=!0;p.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&typeof y.rangeCount=="number"&&c.features.implementsDomRange&&function(){var a=document.createElement("iframe");H.appendChild(a);var b=j.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");b.close();var d=j.getIframeWindow(a).getSelection(),
...
this.docSelection.type!="None"){var a;if(this.anchorNode)a=j.getDocument(this.anchorNode);else if(this.docSelection.type=="Control"){var b=this.docSelection.createRange();b.length&&(a=j.getDocument(b.item(0)).body.createTextRange())}a&&(a.body.createTextRange().select(),this.docSelection.empty())}}catch(d){}f(this)},u.addRange=function(a){this.docSelection.type=="Control"?l(this,a):(r.rangeToTextRange(a).select(),this._ranges[0]=a,this.rangeCount=1,this.isCollapsed=this._ranges[0].collapsed,e(this,
a,!1))},u.setRanges=function(a){this.removeAllRanges();var b=a.length;b>1?o(this,a):b&&this.addRange(a[0])};else return b.fail("No means of selecting a Range or TextRange was found"),!1;u.getRangeAt=function(a){if(a<0||a>=this.rangeCount)throw new w("INDEX_SIZE_ERR");else return this._ranges[a]};var I;if(G)I=function(a){var b;c.isSelectionValid(a.win)?b=a.docSelection.createRange():(b=j.getBody(a.win.document).createTextRange(),b.collapse(!0));a.docSelection.type=="Control"?n(a):b&&typeof b.text!=
...
r.util={hasClass:a,addClass:d,removeClass:E,hasSameClasses:f,replaceWithOwnChildren:g,elementsHaveSameNonClassAttributes:n,elementHasNonClassAttributes:l,splitNodeAt:j,isEditableElement:z,isEditingHost:s,isEditable:o};c.CssClassApplier=r;c.createCssClassApplier=function(a,b,d){return new r(a,b,d)}});
...
b.warn("Marker element has been removed. Cannot restore selection.")}function e(a,b){return b.compareBoundaryPoints(a.START_TO_START,a)}function f(a,b){var d=(a||document).getElementById(b);d&&d.parentNode.removeChild(d)}c.requireModules(["DomUtil","DomRange","WrappedRange"]);var g=c.dom,h="\ufeff";c.saveSelection=function(d){var d=d||window,f=d.document;if(c.isSelectionValid(d)){var g=c.getSelection(d),h=g.getAllRanges(),o=[],i,q;h.sort(e);for(var j=0,p=h.length;j<p;++j)i=h[j],i.collapsed?(q=a(i,
!1),o.push({markerId:q.id,collapsed:!0})):(q=a(i,!1),i=a(i,!0),o[j]={startMarkerId:i.id,endMarkerId:q.id,collapsed:!1,backwards:h.length==1&&g.isBackwards()});for(j=p-1;j>=0;--j)i=h[j],i.collapsed?i.collapseBefore((f||document).getElementById(o[j].markerId)):(i.setEndBefore((f||document).getElementById(o[j].endMarkerId)),i.setStartAfter((f||document).getElementById(o[j].startMarkerId)));g.setRanges(h);return{win:d,doc:f,rangeInfos:o,restored:!1}}else b.warn("Cannot save selection. This usually happens when the selection is collapsed and the selection document has lost focus.")};
c.restoreSelection=function(a,e){if(!a.restored){for(var f=a.rangeInfos,g=c.getSelection(a.win),h=[],i=f.length,q=i-1,j,p;q>=0;--q){j=f[q];p=c.createRange(a.doc);if(j.collapsed)if(j=(a.doc||document).getElementById(j.markerId)){j.style.display="inline";var x=j.previousSibling;x&&x.nodeType==3?(j.parentNode.removeChild(j),p.collapseToPoint(x,x.length)):(p.collapseBefore(j),j.parentNode.removeChild(j))}else b.warn("Marker element has been removed. Cannot restore selection.");else d(a.doc,p,j.startMarkerId,
!0),d(a.doc,p,j.endMarkerId,!1);i==1&&p.normalizeBoundaries();h[q]=p}i==1&&e&&c.features.selectionHasExtend&&f[0].backwards?(g.removeAllRanges(),g.addRange(h[0],!0)):g.setRanges(h);a.restored=!0}};c.removeMarkerElement=f;c.removeMarkers=function(a){for(var b=a.rangeInfos,d=0,c=b.length,e;d<c;++d)e=b[d],e.collapsed?f(a.doc,e.markerId):(f(a.doc,e.startMarkerId),f(a.doc,e.endMarkerId))}});
rangy.createModule("Serializer",function(c,b){function a(b,d){var d=d||[],c=b.nodeType,e=b.childNodes,f=e.length,g=[c,b.nodeName,f].join(":"),h="",k="";switch(c){case 3:h=b.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;");break;case 8:h="<\!--"+b.nodeValue.replace(/</g,"&lt;").replace(/>/g,"&gt;")+"--\>";break;default:h="<"+g+">",k="</>"}h&&d.push(h);for(c=0;c<f;++c)a(e[c],d);k&&d.push(k);return d}function d(b){b=a(b).join("");return s(b).toString(16)}function e(a,b,d){for(var c=[],e=a,d=d||o.getDocument(a).documentElement;e&&
...
{});ice.env.element=this.element;ice.env.document=this.element.ownerDocument;ice.env.window=ice.env.document.defaultView||window;ice.env.frame=ice.env.window.frameElement;ice.env.selection=this.selection=new ice.Selection(ice.env.frame)},initializeRange:function(){var a=this.selection.createRange();a.setStart(ice.dom.find(this.element,this.blockEl)[0],0);a.collapse(!0);this.selection.addRange(a);ice.env.frame?ice.env.frame.contentWindow.focus():this.element.focus()},initializeChangeEditor:function(){var a=
this,b=ice.env.document.createElement("div");this.element.childNodes.length?(ice.dom.each(ice.dom.contents(this.element),function(a,c){ice.dom.isBlockElement(c)&&b.appendChild(c)}),b.innerHTML===""&&b.appendChild(ice.dom.create("<"+this.blockEl+" ><br/></"+this.blockEl+">"))):b.appendChild(ice.dom.create("<"+this.blockEl+" ><br/></"+this.blockEl+">"));this.element.innerHTML=b.innerHTML;var c=this._getIceNodeClass("insertType"),f=this._getIceNodeClass("deleteType");ice.dom.each(ice.dom.find(this.element,
"."+c+",."+f),function(b,d){for(var k=0,n="",l=d.className.split(" "),b=0;b<l.length;b++){var s=RegExp(a.stylePrefix+"-(\\d+)").exec(l[b]);s&&(k=s[1]);(s=RegExp("("+c+"|"+f+")").exec(l[b]))&&(n=a._getChangeTypeFromAlias(s[1]))}l=ice.dom.attr(d,a.userIdAttribute);a.setUserStyle(l,Number(k));k=ice.dom.attr(d,a.changeIdAttribute);a._changes[k]={type:n,userid:l,username:ice.dom.attr(d,a.userNameAttribute),time:ice.dom.attr(d,a.timeAttribute)}})},enableChangeTracking:function(){this.isTracking=!0;this.pluginsManager.fireEnabled(this.element)},
disableChangeTracking:function(){this.isTracking=!1;this.pluginsManager.fireDisabled(this.element)},setCurrentUser:function(a){this.currentUser=a},handleEvent:function(a){if(this.isTracking)if(a.type=="mouseup"){var b=this;setTimeout(function(){b.mouseUp(a)},200)}else if(a.type=="mousedown")return this.mouseDown(a);else if(a.type=="keypress"){var c=this.keyPress(a);c||a.preventDefault();return c}else if(a.type=="keydown")return(c=this.keyDown(a))||a.preventDefault(),c;else a.type=="keyup"&&this.pluginsManager.fireCaretUpdated()},
createIceNode:function(a,b){var c=ice.env.document.createElement(this.changeTypes[a].tag);ice.dom.addClass(c,this._getIceNodeClass(a));c.appendChild(b?b:ice.env.document.createTextNode(""));this.addChange(this.changeTypes[a].alias,[c]);this.pluginsManager.fireNodeCreated(c);return c},insert:function(a,b){b?this.selection.addRange(b):b=this.getCurrentRange();typeof a==="string"&&(a=document.createTextNode(a));if(!b.collapsed&&(this.deleteContents(),b=this.getCurrentRange(),b.startContainer===b.endContainer&&
this.element===b.startContainer)){ice.dom.empty(this.element);var c=b.getLastSelectableChild(this.element);b.setStartAfter(c);b.collapse(!0)}this._moveRangeToValidTrackingPos(b);c=this.startBatchChange();this._insertNode(a||document.createTextNode("&#xfeff;"),b,!a);this.pluginsManager.fireNodeInserted(a,b);this.endBatchChange(c);return!0},placeholdDeletes:function(){var a=this;this.isPlaceholdingDeletes&&this.revertDeletePlaceholders();this.isPlaceholdingDeletes=!0;this._deletes=[];var b="."+this._getIceNodeClass("deleteType");
ice.dom.each(ice.dom.find(this.element,b),function(b,d){a._deletes.push(ice.dom.cloneNode(d));ice.dom.replaceWith(d,"<"+a._delBookmark+' data-allocation="'+(a._deletes.length-1)+'"/>')});return!0},revertDeletePlaceholders:function(){var a=this;if(!this.isPlaceholdingDeletes)return!1;ice.dom.each(this._deletes,function(b,c){ice.dom.find(a.element,a._delBookmark+"[data-allocation="+b+"]").replaceWith(c)});this.isPlaceholdingDeletes=!1;return!0},deleteContents:function(a,b){var c=!0;b?this.selection.addRange(b):
b=this.getCurrentRange();var f=this.startBatchChange(this.changeTypes.deleteType.alias);b.collapsed===!1?this._deleteFromSelection(b):c=a?this._deleteFromRight(b):this._deleteFromLeft(b);this.selection.addRange(b);this.endBatchChange(f);return c},getChanges:function(){return this._changes},getElementContent:function(){return this.element.innerHTML},getCleanContent:function(a,b){var c="",f=this;ice.dom.each(this.changeTypes,function(a,b){a!="deleteType"&&(b>0&&(c+=","),c+="."+f._getIceNodeClass(a))});
var a=a?typeof a==="string"?ice.dom.create("<div>"+a+"</div>"):ice.dom.cloneNode(a)[0]:ice.dom.cloneNode(this.element)[0],g=ice.dom.find(a,c);ice.dom.each(g,function(){ice.dom.replaceWith(this,ice.dom.contents(this))});g=ice.dom.find(a,"."+this._getIceNodeClass("deleteType"));ice.dom.remove(g);a=b?b.call(this,a):a;return a.innerHTML},acceptAll:function(){this.element.innerHTML=this.getCleanContent()},rejectAll:function(){var a="."+this._getIceNodeClass("insertType"),b="."+this._getIceNodeClass("deleteType");
ice.dom.remove(ice.dom.find(this.element,a));ice.dom.each(ice.dom.find(this.element,b),function(a,b){ice.dom.replaceWith(b,ice.dom.contents(b))})},acceptChange:function(a){this.acceptRejectChange(a,!0)},rejectChange:function(a){this.acceptRejectChange(a,!1)},acceptRejectChange:function(a,b){var c,f,g,h,k,n,l=ice.dom;if(!a)if(c=this.getCurrentRange(),c.collapsed)a=c.startContainer;else return;c=g="."+this._getIceNodeClass("deleteType");f=h="."+this._getIceNodeClass("insertType");k=l.getNode(a,c+","+
f);n=l.find(this.element,"["+this.changeIdAttribute+"="+l.attr(k,this.changeIdAttribute)+"]");b||(g=f,h=c);ice.dom.is(k,h)?l.each(n,function(a,b){l.replaceWith(b,ice.dom.contents(b))}):l.is(k,g)&&l.remove(n)},isInsideChange:function(a){var b="."+this._getIceNodeClass("insertType")+", ."+this._getIceNodeClass("deleteType");if(!a)if(range=this.getCurrentRange(),range.collapsed)a=range.startContainer;else return!1;return!!ice.dom.getNode(a,b)},addChangeType:function(a,b,c){this.changeTypes[a]={tag:b,
alias:c}},getIceNode:function(a,b){var c="."+this._getIceNodeClass(b);return ice.dom.getNode(a,c)},_moveRangeToValidTrackingPos:function(a){for(var b=!1,c=this._getVoidElement(a.endContainer);c;){try{a.moveEnd(ice.dom.CHARACTER_UNIT,1),a.moveEnd(ice.dom.CHARACTER_UNIT,-1)}catch(f){b=!0}if(b||ice.dom.onBlockBoundary(a.endContainer,a.startContainer,this.blockEl)){a.setStartAfter(c);a.collapse(!0);break}(c=this._getVoidElement(a.endContainer))?(a.setEnd(a.endContainer,0),a.moveEnd(ice.dom.CHARACTER_UNIT,
ice.dom.getNodeTextContent(a.endContainer).length),a.collapse()):(a.setStart(a.endContainer,0),a.collapse(!0))}},_getVoidElement:function(a){var b=this._getVoidElSelector();return ice.dom.is(a,b)?a:ice.dom.parents(a,b)[0]||null},_getVoidElSelector:function(){return"."+this._getIceNodeClass("deleteType")+","+this.avoid},_currentUserIceNode:function(a){return ice.dom.attr(a,this.userIdAttribute)==this.currentUser.id},_getChangeTypeFromAlias:function(a){var b,c=null;for(b in this.changeTypes)this.changeTypes.hasOwnProperty(b)&&
this.changeTypes[b].alias==a&&(c=b);return c},_getIceNodeClass:function(a){return this.attrValuePrefix+this.changeTypes[a].alias},getUserStyle:function(a){var b=null;return b=this._userStyles[a]?this._userStyles[a]:this.setUserStyle(a,this.getNewStyleId())},setUserStyle:function(a,b){var c=this.stylePrefix+"-"+b;this._styles[b]||(this._styles[b]=!0);return this._userStyles[a]=c},getNewStyleId:function(){var a=++this._uniqueStyleIndex;return this._styles[a]?this.getNewStyleId():(this._styles[a]=!0,
a)},addChange:function(a,b){var c=this._batchChangeid||this.getNewChangeId();this._changes[c]||(this._changes[c]={type:this._getChangeTypeFromAlias(a),time:(new Date).getTime(),userid:this.currentUser.id,username:this.currentUser.name});var f=this;ice.dom.foreach(b,function(a){f.addNodeToChange(c,b[a])});return c},addNodeToChange:function(a,b){if(this._batchChangeid!==null)a=this._batchChangeid;var c=this.getChange(a);b.getAttribute(this.changeIdAttribute)||b.setAttribute(this.changeIdAttribute,a);
...
return b},getNewChangeId:function(){var a=++this._uniqueIDIndex;this._changes[a]&&(a=this.getNewChangeId());return a},startBatchChange:function(){return this._batchChangeid=this.getNewChangeId()},endBatchChange:function(a){if(a===this._batchChangeid)this._batchChangeid=null},getCurrentRange:function(){return this.selection.getRangeAt(0)},_insertNode:function(a,b,c){var f=this._currentUserIceNode(this.getIceNode(b.startContainer,"insertType"));if(!c||!f)f||(a=this.createIceNode("insertType",a)),b.insertNode(a),
c&&(b.setStart(a,0),b.setEnd(a,1)),this.selection.addRange(b)},_deleteFromSelection:function(a){for(var b=new ice.Bookmark(a),c=ice.dom.getElementsBetween(b.start,b.end),f=ice.dom.parents(a.startContainer,this.blockEl)[0],g=ice.dom.parents(a.endContainer,this.blockEl)[0],h=[],k=c.length,n=0;n<k;n++){var l=c[n];ice.dom.is(l,this.blockEl)&&h.push(l);if(!(l.nodeType===ice.dom.TEXT_NODE&&ice.dom.getNodeTextContent(l)==="")&&!this._getVoidElement(l)){if(l.nodeType!==ice.dom.TEXT_NODE){ice.dom.remove(ice.dom.find(l,
"br"));var s=ice.dom.cloneNode(l);ice.dom.remove(ice.dom.find(s,this._getVoidElSelector()));if(ice.dom.getNodeTextContent(s).length===0)continue;else if(ice.dom.is(l,this.blockEl)){s=this.createIceNode("deleteType");newEl=document.createElement(this.blockEl);s.innerHTML=l.innerHTML;l.innerHTML="";l.appendChild(s);continue}}s=this.createIceNode("deleteType");ice.dom.insertBefore(l,s);s.appendChild(l)}}if(f!==g){for(;h.length;)ice.dom.mergeContainers(h.shift(),f);ice.dom.mergeContainers(g,f)}(c=b.start.previousSibling)?
(b.selectBookmark(),a=this.getCurrentRange(),a.moveStart(ice.dom.CHARACTER_UNIT,-1),a.moveStart(ice.dom.CHARACTER_UNIT,1)):(c=ice.env.document.createTextNode(""),ice.dom.insertBefore(b.start,c),this.selection.addRange(a),b.selectBookmark(),a=this.getCurrentRange(),a.setStart(c,0));a.collapse(!0)},_deleteFromRight:function(a){var b=ice.dom.parents(a.startContainer,this.blockEl)[0]||ice.dom.is(a.startContainer,this.blockEl)&&a.startContainer||null,c=b&&b.nextSibling||null,f=ice.dom.is(a.startContainer,
this.blockEl)&&ice.dom.getNodeTextContent(a.startContainer)=="";a.moveEnd(ice.dom.CHARACTER_UNIT,1);a.moveEnd(ice.dom.CHARACTER_UNIT,-1);if(!c&&!ice.dom.isChildOf(a.endContainer,this.element))return a.moveEnd(ice.dom.CHARACTER_UNIT,-1),a.moveEnd(ice.dom.CHARACTER_UNIT,1),a.collapse(),!0;if(ice.dom.onBlockBoundary(a.endContainer,a.startContainer,this.blockEl)||f)return c!==ice.dom.parents(a.endContainer,this.blockEl)[0]&&a.setEnd(c,0),ice.dom.remove(ice.dom.find(a.startContainer,"br")),ice.dom.mergeBlockWithSibling(a,
ice.dom.parents(a.startContainer,this.blockEl)[0]||b,!0);if(this._getVoidElement(a.endContainer))return a.setEnd(a.endContainer,0),a.moveEnd(ice.dom.CHARACTER_UNIT,ice.dom.getNodeTextContent(a.endContainer).length||0),a.collapse(),this._deleteFromRight(a);a.collapse();b=a.startContainer;if(a.startContainer.data&&a.endOffset===b.data.length){c=a.cloneRange();c.moveEnd(ice.dom.CHARACTER_UNIT,1);if(f=ice.dom.getBlockParent(c.endContainer,this.element)){if(ice.dom.isChildOf(f,this.element)===!1)return;
var g=ice.dom.getBlockParent(c.startContainer,this.element);if(f!==g){ice.dom.mergeContainers(f,g);a.setStart(c.startContainer,c.startContainer.data.length);a.collapse(!0);return}}b=a.getNextContainer(b);if(ice.dom.isChildOf(b,this.element)===!1)return!1;b=a.getFirstSelectableChild(b);a.setStart(b,0);this._addTextNodeTracking(b,a)}else if(b=this.getIceNode(a.startContainer,"insertType"),b===null||!this._currentUserIceNode(b))this._addTextNodeTracking(a.startContainer,a,!0);else if(a.moveEnd(ice.dom.CHARACTER_UNIT,
1),a.deleteContents(),b!==null&&ice.dom.isBlank(ice.dom.getNodeTextContent(b))===!0){c=b.previousSibling;if(!c||c.nodeType!==ice.dom.TEXT_NODE)c=ice.env.document.createTextNode(""),ice.dom.insertBefore(b,c);a.setStart(c,c.data.length);ice.dom.remove(b)}a.collapse(!0);return!0},_deleteFromLeft:function(a){var b=ice.dom.parents(a.startContainer,this.blockEl)[0]||ice.dom.is(a.startContainer,this.blockEl)&&a.startContainer||null,c=b&&b.previousSibling||null,f=ice.dom.is(a.startContainer,this.blockEl)&&
ice.dom.getNodeTextContent(a.startContainer)=="";a.moveStart(ice.dom.CHARACTER_UNIT,-1);var g=a.startOffset===a.endOffset&&a.startContainer===a.endContainer,h=!ice.dom.isChildOf(a.startContainer,this.element);a.moveStart(ice.dom.CHARACTER_UNIT,1);if(g||!c&&h)return a.moveStart(ice.dom.CHARACTER_UNIT,1),a.moveStart(ice.dom.CHARACTER_UNIT,-1),a.collapse(!0),!0;if(ice.dom.onBlockBoundary(a.startContainer,a.endContainer,this.blockEl)||f)return c!==ice.dom.parents(a.startContainer,this.blockEl)[0]&&a.setStart(c,
0),ice.dom.remove(ice.dom.find(a.endContainer,"br")),ice.dom.mergeBlockWithSibling(a,ice.dom.parents(a.endContainer,this.blockEl)[0]||b);if(this._getVoidElement(a.startContainer))return a.setStart(a.startContainer,0),a.collapse(!0),this._deleteFromLeft(a);b=a.startContainer;if(a.startOffset===0){c=a.cloneRange();c.moveStart(ice.dom.CHARACTER_UNIT,-1);if(f=ice.dom.getBlockParent(c.startContainer,this.element)){if(ice.dom.isChildOf(f,this.element)===!1)return!1;g=ice.dom.getBlockParent(c.endContainer,
...
0||this.getIceNode(a,"deleteType")!==null)){var f="",g="",h="";c?(f=a.nodeValue.substring(0,b.endOffset),g=a.nodeValue.substr(b.endOffset,1),h=a.nodeValue.substring(b.endOffset+1)):(f=a.nodeValue.substring(0,b.startOffset-1),g=a.nodeValue.substr(b.startOffset-1,1),h=a.nodeValue.substring(b.startOffset));if(b.startOffset===1&&!c||c&&b.startOffset===0){var k=this.getIceNode(a.previousSibling,"deleteType");k!==null&&!this._currentUserIceNode(k)&&(k=null);if(k){if(c)if(k.lastChild&&k.lastChild.nodeType===
ice.dom.TEXT_NODE?k.lastChild.nodeValue+=g:(c=ice.env.document.createTextNode(g),k.appendChild(c)),a.nodeValue=f+h,a.nodeValue.length===0){c=!1;for(a=a.nextSibling;!c;)(k=this.getIceNode(a,"deleteType"))?a=a.nextSibling:c=!0;a&&(b.setStart(a,0),b.collapse(!0))}else b.setStart(a,0),b.collapse(!0);else if(k.lastChild&&k.lastChild.nodeType===ice.dom.TEXT_NODE?(k.lastChild.nodeValue+=g,b.setStart(k.lastChild,k.lastChild.nodeValue.length-1)):(c=ice.env.document.createTextNode(g),k.appendChild(c),b.setStart(c,
0)),a.nodeValue=f+h,a.nodeValue=f+h,a.nodeValue.length===0){c=!1;for(a=a.previousSibling;!c;)(k=this.getIceNode(a,"deleteType"))?a=a.previousSibling:c=!0;a&&(a=b.getLastSelectableChild(a),b.setStart(a,a.nodeValue.length),b.collapse(!0))}else b.collapse(!0);return}}if(b.startOffset===a.nodeValue.length&&(k=this.getIceNode(a.nextSibling,"deleteType"),k!==null&&!this._currentUserIceNode(k)&&(k=null),k)){k.firstChild&&k.firstChild.nodeType===ice.dom.TEXT_NODE?k.firstChild.nodeValue=g+k.firstChild.nodeValue:
(c=ice.env.document.createTextNode(g),ice.dom.insertBefore(k.firstChild,c));a.nodeValue=f;b.setStart(a,a.nodeValue.length);b.setEnd(a,a.nodeValue.length);return}k=this.createIceNode("deleteType");f=null;c!==!0?(f=a.splitText(b.startOffset-1),f.nodeValue=f.nodeValue.substring(1),ice.dom.insertAfter(a,f),k.firstChild.nodeValue=g,ice.dom.insertAfter(a,k),b.setStart(a,a.nodeValue.length),b.setEnd(a,a.nodeValue.length)):(f=a.splitText(b.endOffset),f.nodeValue=f.nodeValue.substring(1),ice.dom.insertAfter(a,
f),k.firstChild.nodeValue=g,ice.dom.insertAfter(a,k),b.setStart(f,0),b.setEnd(f,0))}},_handleAncillaryKey:function(a){var b=!0;switch(a.keyCode){case ice.dom.DOM_VK_DELETE:b=this.deleteContents();this.pluginsManager.fireKeyPressed(a);break;case 46:this.deleteContents(!0);this.pluginsManager.fireKeyPressed(a);break;case ice.dom.DOM_VK_DOWN:case ice.dom.DOM_VK_UP:case ice.dom.DOM_VK_LEFT:case ice.dom.DOM_VK_RIGHT:this.pluginsManager.fireCaretPositioned();b=!1;break;default:b=!1}return b===!0?(ice.dom.preventDefault(a),
...
this.plugins[f]=g,ice.dom.isset(e.settings)===!0&&g.setSettings(e.settings),g.start())}},setActivePlugin:function(b,a){this.activePlugin=b;this.allowTextInput=a||!1},getActivePlugin:function(){return this.activePlugin},_getPluginName:function(b){b=b.toString();return b.substr(9,b.indexOf("(")-9)},removePlugin:function(b){this.plugins[b]&&(this.plugins[b].remove(),this.removeKeyPressListener(this.plugins[b]),this.fireCallbacks("pluginRemoved",b))},getPlugin:function(b){return this.plugins[b]},usePlugins:function(b,
a,c){var e=this;this.pluginSets[b]=ice.dom.isset(a)===!0?a:[];this.loadPlugins(this.pluginSets[b].concat([]),function(){e._enableSet(b);c&&c.call(this)})},disablePlugin:function(b){this.plugins[b].disable()},isPluginElement:function(b){for(var a in this.plugins)if(this.plugins[a].isPluginElement&&this.plugins[a].isPluginElement(b)===!0)return!0;return!1},addKeyPressListener:function(b,a,c,e){b=b.toLowerCase().split("+").sort();a={plugin:a,fn:c,data:e};c=b.join("+");this.keyPressListeners[c]||(this.keyPressListeners[c]=
[]);this.keyPressListeners[c].push(a)},removeKeyPressListener:function(b,a){if(b&&a&&this.keyPressListeners[a])for(var c=this.keyPressListeners[a].length,e=0;e<c;e++){var f=this.keyPressListeners[a][e];if(f.plugin===b){this.keyPressListeners[a].splice(e,1);break}}else if(b)for(var g in this.keyPressListeners)if(this.keyPressListeners.hasOwnProperty(g)!==!1)if(c=this.keyPressListeners[g].length,c===0)delete this.keyPressListeners[g];else for(e=0;e<c;e++)if(f=this.keyPressListeners[g][e],f.plugin===
b){this.keyPressListeners[g].splice(e,1);break}},fireKeyPressed:function(b){if(this._fireKeyPressFns(b,"all_keys")===!1)return!1;var a=[];(b.ctrlKey===!0||b.metaKey===!0)&&a.push("ctrl");b.shiftKey===!0&&a.push("shift");b.altKey===!0&&a.push("alt");switch(b.keyCode){case 13:a.push("enter");break;case ice.dom.DOM_VK_LEFT:a.push("left");break;case ice.dom.DOM_VK_RIGHT:a.push("right");break;case ice.dom.DOM_VK_UP:a.push("up");break;case ice.dom.DOM_VK_DOWN:a.push("down");break;case 9:a.push("tab");break;
case ice.dom.DOM_VK_DELETE:a.push("delete");break;default:var c;if(b.keyCode)c=b.keyCode;else if(b.which)c=b.which;c&&a.push(String.fromCharCode(c).toLowerCase())}a=a.sort().join("+");return this._fireKeyPressFns(b,a)},_fireKeyPressFns:function(b,a){if(this.keyPressListeners[a])for(var c=this.keyPressListeners[a].length,e=0;e<c;e++){var f=this.keyPressListeners[a][e],g=f.fn,h=f.plugin,f=f.data;if(g)if(ice.dom.isFn(g)===!0){if(g.call(h,b,f)===!0)return ice.dom.preventDefault(b),!1}else if(h[g]&&h[g].call(h,
b,f)===!0)return ice.dom.preventDefault(b),!1}return!0},fireSelectionChanged:function(b){for(var a in this.plugins)this.plugins[a].selectionChanged(b)},fireNodeInserted:function(b,a){for(var c in this.plugins)if(this.plugins[c].nodeInserted(b,a)===!1)return!1},fireNodeCreated:function(b){for(var a in this.plugins)if(this.plugins[a].nodeCreated(b)===!1)return!1},fireCaretPositioned:function(){for(var b in this.plugins)this.plugins[b].caretPositioned()},fireClicked:function(b){var a=!0,c;for(c in this.plugins)this.plugins[c].clicked(b)===
!1&&(a=!1);return a},fireMouseDown:function(b){var a=!0,c;for(c in this.plugins)this.plugins[c].mouseDown(b)===!1&&(a=!1);return a},fireKeyDown:function(b){var a=!0,c;for(c in this.plugins)this.plugins[c].keyDown(b)===!1&&(a=!1);return a},fireKeyPress:function(b){var a=!0,c;for(c in this.plugins)this.plugins[c].keyPress(b)===!1&&(a=!1);return a},fireEnabled:function(b){for(var a in this.plugins)this.plugins[a].setEnabled(b)},fireDisabled:function(b){for(var a in this.plugins)this.plugins[a].setDisabled(b)},
fireCaretUpdated:function(){for(var b in this.plugins)this.plugins[b].caretUpdated&&this.plugins[b].caretUpdated()},registerCallback:function(b,a,c){ice.dom.isFn(c)!==!1&&(ice.dom.isset(this.callbacks[b])===!1&&(this.callbacks[b]={}),this.callbacks[b][a]=c)},fireCallbacks:function(b,a){if(ice.dom.isset(this.callbacks[b])===!0)for(var c in this.callbacks[b])this.callbacks[b][c].call(b,a)},removeCallback:function(b,a){delete this.callbacks[b][a]}};this.ice.IcePluginManager=c}).call(this);
...
(function(){var c=this.ice,b;b=function(a){this._ice=a;this._tmpNode=null;this._tmpNodeTagName="icepaste";var b=this;this.pasteType="formattedClean";this.preserve="p";this.afterPasteClean=function(a){return a};a.element.oncopy=function(){return b.handleCopy.apply(b)};a.element.oncut=function(){return b.handleCut.apply(b)};a.element.onpaste=function(){return b.handlePaste.apply(b)}};b.prototype={setSettings:function(a){a=a||{};c.dom.extend(this,a);this.preserve+=","+this._tmpNodeTagName;this.setupPreserved()},
handleCut:function(){if(this._ice.isTracking){var a=this._ice.getCurrentRange();if(!a.collapsed){var b=a.cloneContents(),c=this;setTimeout(function(){c.doCut(b)},1);return!0}}},doCut:function(a){var b=this._ice.getCurrentRange(),e,f;this._tmpNode=c.env.document.createElement("span");b.insertNode(this._tmpNode);b.setStartAfter(this._tmpNode);for(b.collapse(!0);e=a.firstChild;)b.insertNode(e),b.setStartAfter(e),b.collapse(!0),f=e;b.setStartBefore(this._tmpNode);b.collapse(!0);b.setEndAfter(f);c.env.selection.addRange(b);
this._ice.deleteContents();c.dom.remove(this._tmpNode)},handleCopy:function(){},handlePaste:function(){var a=this._ice.getCurrentRange();a.collapsed||(this._ice.isTracking?(this._ice.deleteContents(),a=a.cloneRange()):(a.deleteContents(),a.collapse(!0)));this._ice.isTracking&&this._ice._moveRangeToValidTrackingPos(a);this._tmpNode=c.env.document.createElement("icepaste");a.insertNode(this._tmpNode);var a=c.dom.extractContent(this._ice.element),b=c.env.selection.createRange();b.selectNodeContents(this._ice.element);
c.env.selection.addRange(b);switch(this.pasteType){case "formatted":this.handleFormattedPaste(a);break;case "formattedClean":this.handleFormattedPaste(a,!0)}return!0},handleFormattedPaste:function(a,b){var c=this;window.setTimeout(function(){c.handleFormattedPasteValue(a,b)},1);return!0},handleFormattedPasteValue:function(a,b){var e=this._ice.element.innerHTML,f=c.dom.children("<div>"+e+"</div>",this._ice.blockEl);f.length===1&&c.dom.getNodeTextContent("<div>"+e+"</div>")===c.dom.getNodeTextContent(f)&&
(e=c.dom.getHtml(e));this._ice.element.innerHTML="";this._ice.element.appendChild(a);var e=b?this.stripPaste(e):this.afterPasteClean.call(this,e),e=c.dom.trim(e),g=this._ice.getCurrentRange();g.setStartAfter(this._tmpNode);g.collapse(!0);var h=null,e=g.createContextualFragment(e),f=this._ice.startBatchChange(this._ice.changeTypes.insertType.alias);if(c.dom.hasBlockChildren(e)){var k=c.dom.isChildOfTagName(this._tmpNode,this._ice.blockEl);g.setEndAfter(k.lastChild);this._ice.selection.addRange(g);
var h=g.extractContents(),n=c.env.document.createElement(this._ice.blockEl);n.appendChild(h);c.dom.insertAfter(k,n);g.setStart(n,0);g.collapse(!0);this._ice.selection.addRange(g);for(var g=g.startContainer,l=null,k=null;e.firstChild;)if(e.firstChild.nodeType===3&&!jQuery.trim(e.firstChild.nodeValue))e.removeChild(e.firstChild);else if(c.dom.isBlockElement(e.firstChild)){if(e.firstChild.textContent!=="")k=l=null,this._ice.isTracking?(k=this._ice.createIceNode("insertType"),this._ice.addChange("insertType",
[k]),h=document.createElement(e.firstChild.tagName),k.innerHTML=e.firstChild.innerHTML,h.appendChild(k)):(k=h=document.createElement(e.firstChild.tagName),h.innerHTML=e.firstChild.innerHTML),c.dom.insertBefore(g,h);e.removeChild(e.firstChild)}else l||(h=document.createElement(this._ice.blockEl),c.dom.insertBefore(g,h),this._ice.isTracking?(l=this._ice.createIceNode("insertType"),this._ice.addChange("insertType",[l]),h.appendChild(l)):l=h),k=l,l.appendChild(e.removeChild(e.firstChild));n.textContent||
n.parentNode.removeChild(n)}else if(this._ice.isTracking)h=this._ice.createIceNode("insertType",e),this._ice.addChange("insertType",[h]),g.insertNode(h),k=h;else for(;n=e.firstChild;)g.insertNode(n),g.setStartAfter(n),g.collapse(!0),k=n;this._ice.endBatchChange(f);this._cleanup(k)},stripPaste:function(a){a=this._ice.getCleanContent(a);a=this._cleanWordPaste(a);a=this.cleanPreserved(a);return this.afterPasteClean.call(this,a)},setupPreserved:function(){var a=this;this._tags="";this._attributesMap=
[];c.dom.each(this.preserve.split(","),function(b,c){c.match(/(\w+)(\[(.+)\])?/);var f=RegExp.$1,g=RegExp.$3;a._tags&&(a._tags+=",");a._tags+=f.toLowerCase();a._attributesMap[f]=g.split("|")})},cleanPreserved:function(a){var b=this,e=c.env.document.createElement("div");e.innerHTML=a;e=c.dom.stripEnclosingTags(e,this._tags);c.dom.each(c.dom.find(e,this._tags),function(a,e){var h=e.tagName.toLowerCase(),h=b._attributesMap[h];if(h[0]&&h[0]==="*")return!0;if(e.hasAttributes())for(var k=e.attributes,a=
k.length-1;a>=0;a--)c.dom.inArray(k[a].name,h)||e.removeAttribute(k[a].name)});return e.innerHTML},_cleanWordPaste:function(a){a=a.replace(/<(meta|link)[^>]+>/g,"");a=a.replace(/<\!--(.|\s)*?--\>/g,"");a=a.replace(/<style>[\s\S]*?<\/style>/g,"");a=a.replace(/<\/?\w+:[^>]*>/gi,"");a=a.replace(/<\\?\?xml[^>]*>/gi,"");a=this._cleanPaste(a);a=this._convertWordPasteList(a);a=a.replace(/<(\w[^>]*) (lang)=([^ |>]*)([^>]*)/gi,"<$1$4");return a=a.replace(RegExp('<(\\w[^>]*) style="([^"]*)"([^>]*)',"gi"),"<$1$3")},
_getListType:function(a,b){var e=c.dom.getHtml(a),f=null;c.dom.foreach(b,function(a){c.dom.foreach(b[a],function(h){c.dom.foreach(b[a][h],function(c){if(RegExp(b[a][h][c]).test(e)===!0)return f={html:e.replace(RegExp(b[a][h][c]),""),listType:a,listStyle:h},!1});if(f!==null)return!1});if(f!==null)return!1});return f},_convertWordPasteList:function(a){var b=document.createElement("div"),e=null,f=null,g={},h=null,k=!0,n={ul:{circle:["^o(s|&nbsp;)+"],disc:["^"+String.fromCharCode(183)+"(\\s|&nbsp;)+"],
square:["^"+String.fromCharCode(167)+"(\\s|&nbsp;)+"],auto:["^"+String.fromCharCode(8226)+"(\\s|&nbsp;)+"]},ol:{decimal:["^\\d+\\.(s|&nbsp;)+"],"lower-roman":["^[ivxlcdm]+\\.(\\s|&nbsp;)+"],"upper-roman":["^[IVXLCDM]+\\.(\\s|&nbsp;)+"],"lower-alpha":["^[a-z]+\\.(\\s|&nbsp;)+"],"upper-alpha":["^[A-Z]+\\.(\\s|&nbsp;)+"]}};c.dom.setHtml(b,a);for(var a=c.dom.getTag("p",b),l=a.length,s=0;s<l;s++){var o=a[s],i=this._getListType(o,n);if(i!==null){var q=parseInt(c.dom.getStyle(o,"margin-left")),j=i.listType,
p=i.listStyle;c.dom.setHtml(o,i.html);j||(j="ol");k?(e=document.createElement(j),g={},c.dom.attr(e,"_icelistst","list-style-type:"+p),g[q]=e,c.dom.insertBefore(o,e)):q!==f&&(c.dom.isset(g[q])===!0?e=g[q]:q>f&&(e=document.createElement(j),c.dom.attr(e,"_icelistst","list-style-type:"+p),h.appendChild(e),g[q]=e));h=this._createListItemFromElement(o);e.appendChild(h);f=q;c.dom.remove(o);k=!1}else k=!0}return a=c.dom.getHtml(b)},_createListItemFromElement:function(a){for(var b=document.createElement("li");a.firstChild;)b.appendChild(a.firstChild);
return b},_cleanPaste:function(a){a=a.replace(/<b(\s+|>)/g,"<strong$1");a=a.replace(/<\/b(\s+|>)/g,"</strong$1");a=a.replace(/<i(\s+|>)/g,"<em$1");return a=a.replace(/<\/i(\s+|>)/g,"</em$1")},_cleanup:function(a){try{var a=a&&a.lastChild||a||this._tmpNode,b=this._ice.getCurrentRange();b.setStart(a,a.length);b.collapse(!0);this._ice.selection.addRange(b);c.env.frame?c.env.frame.contentWindow.focus():this._ice.element.focus();this._tmpNode.parentNode.removeChild(this._tmpNode);this._tmpNode=null;for(var e=
c.env.document.getElementsByClassName(this._ice.changeTypes.insertType.alias),a=0;a<e.length;a++)e[a].textContent||e[a].parentNode&&e[a].parentNode.removeChild(e[a])}catch(f){window.console&&console.error(f)}}};c.dom.noInclusionInherits(b,c.IcePlugin);this.ice._plugin.IceCopyPastePlugin=b}).call(this);
...
a===String.fromCharCode(32)},k=this.ice.selection.createRange(),n=a.cloneNode(!0);k.setStart(n,0);k.collapse(!0);for(var n=[],l=null,s=null,o=null,i=0;;)try{k.moveEnd("character",1),n.push(k.cloneContents().textContent.charAt(i++))}catch(q){break}for(i=0;i<=n.length;i++)switch(l=s,s=o,o=n.length===i?null:n[i],s){case b:case c:this.replaceCharAtPosition("'",i,a);case "'":(l===null||h(l))&&/\d/.test(o)&&/\d/.test(n[i+1])&&h(n[i+2])?this.replaceCharAtPosition(c,i,a):l===null||h(l)&&!h(o)?this.replaceCharAtPosition(b,
